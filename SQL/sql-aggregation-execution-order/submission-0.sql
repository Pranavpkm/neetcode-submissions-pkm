...
SELECT country, year,sum(gold+silver+bronze) as total medals
from olympic_medals
where category IS NOT LIKE 'gymnastics'
group by sum(total_medals)>20
order by total_medals in desc;
